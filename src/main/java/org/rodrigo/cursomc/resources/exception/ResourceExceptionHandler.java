...
import org.rodrigo.cursomc.services.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonServiceException(AmazonServiceException e, HttpServletRequest request) {
		HttpStatus s = HttpStatus.valueOf(e.getErrorCode());
		StandardError err = new StandardError(s.value(), e.getMessage(), System.currentTimeMillis());
